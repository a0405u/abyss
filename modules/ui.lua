...
function ui:init()
    ...
    self.left.buttons = {
        ...
        function() game:set_tool(game.tools.building, {BuildingSupport(), BuildingArch(), BuildingArcade()}, true) end),
        box = Button(Vector(56, 29), sprites.ui.button_small, sprites.ui.icons_small.block, nil, nil,
        function() game:set_tool(game.tools.building, BuildingBlock(), true) end),
        soil = Button(Vector(74, 29), sprites.ui.button_small, sprites.ui.icons_small.soil, nil, nil,
        function() game:set_tool(game.tools.building, BuildingSoil(), true) end),
